...
def _go_swagger_generate_impl(ctx):
  print("""
EXPERIMENTAL: the go_swagger_test rule is still very experimental
...
{go} generate -run swagger {packages}
""".format(
      go=go.go.short_path,
...
def go_swagger_test(name, data, **kwargs):
